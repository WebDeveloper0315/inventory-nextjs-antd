...
function OneGraph() {
    ...
    const onFinish = async () => {
        try {
            ...
            const response = await axios.get(`/api/products/queryOne?popCode=${queryCode}`)
            ...
            if (response.status === 201) {
                setTableData([
                    ...
                    { label: 'Average sell price', value: response.data.averageSellPrice },
                    { label: 'Profit', value: response.data.profit },
                    { label: 'Average Money in tax', value: response.data.averageMoneyInTax },
                ])
                        ...
                        {imageUrl &&
                            <div className='flex flex-col justify-center items-center'>
                                ...
                                <div className='flex flex-row items-center'>
                                    <Button type="primary" style={{ margin: '10px' }} onClick={onFinish}>Yes</Button>
